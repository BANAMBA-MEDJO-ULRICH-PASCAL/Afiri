...
OFFRES_DATA = [
    ...
    {"titre": "Stage Développeur Front-end React", "description": "Intégrez des interfaces React pour des clients locaux et régionaux.", "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "Stage UI/UX Designer",           "description": "Créez des maquettes Figma et améliorez l'expérience utilisateur.",    "localisation": "Yaoundé", "type_contrat": "Stage", "domaine": "Marketing"},
    {"titre": "Stage Data Scientist",           "description": "Analysez des jeux de données et construisez des modèles prédictifs.", "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "Alternance Assistant RH",        "description": "Participez au recrutement et à l'onboarding des nouveaux talents.",   "localisation": "Yaoundé", "type_contrat": "Alternance", "domaine": "Gestion"},
    {"titre": "Stage Community Manager",        "description": "Animez les réseaux sociaux et créez du contenu engageant.",           "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Marketing"},
    {"titre": "CDD Développeur Python",         "description": "Développez des scripts et API en Python pour l'automatisation.",      "localisation": "Yaoundé", "type_contrat": "CDD",   "domaine": "Informatique"},
    {"titre": "Stage Analyste Cybersécurité",  "description": "Participez aux audits de sécurité et à la veille technologique.",     "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "Stage Graphiste Digital",        "description": "Produisez des visuels pour campagnes web et print.",                  "localisation": "Bafoussam", "type_contrat": "Stage", "domaine": "Marketing"},
    {"titre": "CDI Contrôleur de Gestion",      "description": "Suivez les budgets et produisez des tableaux de bord financiers.",  "localisation": "Yaoundé", "type_contrat": "CDI",   "domaine": "Finance"},
    {"titre": "Stage Testeur QA",               "description": "Testez les applications web et mobiles, rédigez des rapports de bugs.", "localisation": "Douala", "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "Stage Assistant Chef de Projet", "description": "Coordonnez les tâches et suivez l'avancement des projets digitaux.",  "localisation": "Yaoundé", "type_contrat": "Stage", "domaine": "Gestion"},
    {"titre": "CDD Chargé de Clientèle",       "description": "Accueillez et conseillez la clientèle dans nos agences.",             "localisation": "Douala",  "type_contrat": "CDD",   "domaine": "Gestion"},
    {"titre": "Stage Développeur Mobile Flutter", "description": "Construisez des apps mobiles cross-platform avec Flutter.",         "localisation": "Yaoundé", "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "Stage Rédacteur Web SEO",        "description": "Rédigez des articles optimisés SEO pour notre blog corporate.",       "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Marketing"},
    {"titre": "Alternance Comptable Junior",    "description": "Assistez l'équipe comptable dans la saisie et le rapprochement.",   "localisation": "Yaoundé", "type_contrat": "Alternance", "domaine": "Finance"},
    {"titre": "Stage Administrateur Système",   "description": "Maintenez les serveurs Linux et les services cloud.",                 "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "CDI Juriste d'Entreprise",       "description": "Rédigez et analysez les contrats commerciaux.",                       "localisation": "Yaoundé", "type_contrat": "CDI",   "domaine": "Droit"},
    {"titre": "Stage Product Owner Junior",     "description": "Définissez les user stories et priorisez le backlog produit.",       "localisation": "Douala",  "type_contrat": "Stage", "domaine": "Gestion"},
    {"titre": "Stage Intégrateur Web",          "description": "Intégrez des maquettes en HTML/CSS responsive.",                      "localisation": "Yaoundé", "type_contrat": "Stage", "domaine": "Informatique"},
    {"titre": "CDD Responsable Communication",  "description": "Pilotez la communication interne et externe de l'entreprise.",      "localisation": "Douala",  "type_contrat": "CDD",   "domaine": "Marketing"},
]
